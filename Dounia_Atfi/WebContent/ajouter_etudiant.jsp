            ...
            <div class="form-panel">
              <form role="form" class="form-horizontal style-form" action="inscription" method="post">
                <div class="form-group has-success">
                  ...
                  <div class="col-lg-10">
                    <input type="text" name="nom" placeholder="Nom" id="f-name" class="form-control"/>
                  </div>
                </div>
                <div class="form-group has-error">
                  <label class="col-lg-2 control-label">Prenom</label>
                  <div class="col-lg-10">
                    <input type="text" name="prenom" placeholder="Prenom" id="l-name" class="form-control"/>
                ...
                <div class="form-group has-warning">
                  ...
                  <div class="col-lg-10">
                    <input type="text" name="email" placeholder="Email" id="email2" class="form-control"/>
                 ...
                 <div class="form-group has-warning">
                  ...
                  <div class="col-lg-10">
                    <input type="text" name="mdp" placeholder="Mot de passe" id="email2" class="form-control"/>
                   
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">
                    <input class="btn btn-theme" type="submit" value="Ajouter"/>
                  </div>
                </div>
              </form>
            </div>
