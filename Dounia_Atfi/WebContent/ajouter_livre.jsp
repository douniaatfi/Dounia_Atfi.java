...
<section class="wrapper"> 
  <div class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i> Ajouter livre</h4>
            <div class="form-panel">
              <form role="form" class="form-horizontal style-form" action="livre" method="post">
                <div class="form-group has-success">
                  <label class="col-lg-2 control-label">Réference</label>
                  <div class="col-lg-10">
                    <input type="text"name="isbn" placeholder="" id="f-name" class="form-control">
                  </div>
                </div>
                <div class="form-group has-error">
                  <label class="col-lg-2 control-label">Titre</label>
                  <div class="col-lg-10">
                    <input type="text"name="titre" placeholder="" id="l-name" class="form-control">
                ...
                <div class="form-group has-warning">
                  ...
                  <div class="col-lg-10">
                    <input type="text"name="genre" placeholder="" id="email2" class="form-control">
                 ...
                 <div class="form-group has-warning">
                  ...
                  <div class="col-lg-10">
                    <input type="text" name="description" placeholder="" id="email2" class="form-control">
                   
                  </div>
                </div>
                <div class="form-group has-success">
                  <label class="col-lg-2 control-label">L'anne d'edition</label>
                  <div class="col-lg-10">
                    <input type="number"name="annee_edition" placeholder="" id="f-name" class="form-control">
                  </div>
                </div>
                <div class="form-group has-success">
                ...
                <div class="form-group has-success">
                  ...
                  <div class="col-lg-10">
                    <%ArrayList<Personne> auteurs = servicePersonne.listeAuteur();%>
